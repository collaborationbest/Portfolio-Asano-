        ...
        <div className="row container">
            <div className="columns" data-aos="fade-right" data-aos-delay="300">
                ...
                <h4>
                    <FormattedMessage
                        id='description'
                        defaultMessage='My name is Asano Mamoru.'
                    />
                </h4>
                <p>
                    <FormattedMessage
                        id='my-description'
                        defaultMessage='I am a Full Stack Developer who enjoys building clean and scalable web applications.  I mainly work with Angular on the frontend and have been expanding my backend skills with Node.js and Spring Boot.'
                    />
                </p>
                <ul>
                    <li>
                    ...
                    <li>
                        <p><span>Email:</span> pro.prefessor88@gmail.com</p>
                    </li>
                    <li>
                        <p>
                            <span>
